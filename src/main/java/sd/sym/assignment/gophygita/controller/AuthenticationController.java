...
public class AuthenticationController {
	...
	public MessageResponse loginUser(@RequestBody LoginRequest loginRequest) {
		return authenticationService.loginUser(loginRequest);
	}

	@PostMapping(path = AUTH_REGISTRATION_URL,
			     consumes = MediaType.APPLICATION_JSON_VALUE,
			     produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = AUTH_VERIFICATION_URL,
			    produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = AUTH_EXIST_USERNAME_URL,
			    produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = AUTH_CHECK_USERNAME_URL,
			    produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = AUTH_CHECK_PASSCODE_URL,
			    produces = MediaType.APPLICATION_JSON_VALUE)
	public MessageResponse passcodeVerificationUser
			(@RequestParam("username") String username, @RequestParam("emailPasscode") String emailPasscode) {
		return authenticationService.mailVerificationUser(username, FETCH_PURPOSE, emailPasscode);
	}

	@GetMapping(path = AUTH_CHECK_USERNAME_PASSCODE_URL,
			    produces = MediaType.APPLICATION_JSON_VALUE)
	public MessageResponse getUserData
			(@RequestParam("username") String username, @RequestParam("passcode") String passcode) {
		return authenticationService.mailVerificationUserGetUserData(username, FETCH_PURPOSE, passcode);
	}

	@GetMapping(path = AUTH_CHECK_URL,
			    produces = MediaType.APPLICATION_JSON_VALUE)
